...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--nc", type=int, default=3, help="input image channels"
    )
    parser.add_argument(
    ...
    with open(
        os.path.join(opt.experiment, "generator_config.json"), "w"
    ) as gcfg:
    ...
    if opt.adam:
        ...
        optimizerG_smoothing = optim.RMSprop(netG.parameters(), lr=0.0001)
    ...
    while 1:
        ...
        if gen_iterations % 100 == 0:
            ...
            vis_noise = torch.stack(
                [
                    fixed_noise[0] * (1 - t) + fixed_noise[1] * t
